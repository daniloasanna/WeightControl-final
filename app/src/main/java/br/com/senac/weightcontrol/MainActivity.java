...
public class MainActivity extends AppCompatActivity {
    ...
    private void refreshWeightAppList(JSONArray weightcontrol)throws JSONException {
        weightappList.clear();

        for(int i = 0; i < weightcontrol.length(); i++){
            JSONObject obj = weightcontrol.getJSONObject(i);

            weightappList.add(new WeightControlApp(
                    obj.getInt("id"),
                    obj.getString("peso"),
                    obj.getString("dataafericao"),
                    obj.getString("circunferencia")
            ));
        }
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (!object.getBoolean("error")) {
                    ...
                    refreshWeightAppList(object.getJSONArray("weightcontrol"));
                }
    ...
    class WeightAppAdapter extends ArrayAdapter<WeightControlApp> {
        ...
        public View getView(int position, View converView, ViewGroup parent){
            ...
            TextView textViewCirc = listViewItem.findViewById(R.id.textViewCirc);
            ...
            textViewData.setText(weightapp.getData());
            textViewCirc.setText(weightapp.getCirc());
